...
#define HI_GPSMNG_GSV_MAX_MSG_NUM (4)
...
{
    HI_GPSMNG_TIME time;//时间
    HI_GPSMNG_FLOAT latitude;//纬度
    HI_GPSMNG_FLOAT longitude;//经度
    HI_S32 fixQuality;//gps状态
    HI_S32 satellitesTracked;//卫星数量
    HI_GPSMNG_FLOAT hdop;//水平精度因子
    HI_GPSMNG_FLOAT altitude;//海拔高度
    HI_CHAR altitudeUnits;//地球椭球面相对大地水准面的高度
    HI_GPSMNG_FLOAT height;
    HI_CHAR heightUnits;//高度单位
